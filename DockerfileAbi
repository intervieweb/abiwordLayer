...
ARG GSFPREFIX=/opt/gsf
ARG WVPREFIX=/opt/wv
ARG ABIPREFIX=/opt/abiword
...
ENV PATH=$PATH:/opt/gtk/bin/gtk-update-icon-cache
RUN curl -L https://www.abisource.com/downloads/abiword/${ABIWORD_VERSION}/source/abiword-${ABIWORD_VERSION}.tar.gz | tar -xz && ls
